window.addEventListener("load", function() {
  ...
  function drawBackground() {
    ...
    bgCtx.moveTo(mirrorX, mirrorY - mirrorH / 2);
    bgCtx.lineTo(mirrorX, mirrorY + mirrorH / 2);
...
*/
    ...
    if (showExtRay)
      drawLine(fg.width, rayY, mirrorX, rayY, true);

    // reflected parallel ray
    if ($("#refracted-parallel-ray").checked)
      drawLine(mirrorX, rayY, 0, rayY);
